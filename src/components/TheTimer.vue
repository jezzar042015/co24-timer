<template>
    <div id="timer" @click="showControls" class="h-screen w-full bg-black flex flex-col items-center justify-center relative overflow-hidden">
        <div id="speakers" v-show="timerStore.controls" 
            ...
            <div class="uppercase pl-2 cursor-pointer" @click="gotoHome">{{ partStore.parts.name }}</div>
            <hr>
            <PartsList/>
        </div>
